  ...
  <div class="md:p-4 sm:ml-64">
    <div class="grid md:grid-cols-12 px-24 pt-4">
      ...
      <div class="flex flex-col md:col-span-6 px-4 gap-4">
        ...
        <div class="flex flex-row justify-between">
          <p>{{ user.publications.length }} publicações</p>
          <p>9999 seguidores</p>
          <p>9999 seguindo</p>
        </div>
    ...
    <div class="grid grid-cols-3 gap-1">
      <div v-for="publication in user.publications">
        <div v-for="(photo, index) in publication.photos">
          <img
            v-if="index === 0"
            :src="'../storage/' + photo.photo_path"
            alt="Imagem"
            class="h-32 w-full md:h-80 md:w-full object-cover"
          />
        </div>
      </div>
    </div>
